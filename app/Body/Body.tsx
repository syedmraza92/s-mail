  ...
  return (
    <>
      {emails.map((email, index) => (
        <div
          key={index}
          className="flex bg-white items-center h-12 border-b border-solid border-[#f5f5f5] cursor-pointer hover:border-t hover:border-solid hover:border-[#f5f5f5] hover:shadow-lg"
        >
          ...
          <div className="w-full flex justify-start whitespace-nowrap overflow-hidden text-ellipsis pr-1 pl-1">
            <h4 className="p-3 font-semibold whitespace-nowrap overflow-hidden">
              {email.to}
